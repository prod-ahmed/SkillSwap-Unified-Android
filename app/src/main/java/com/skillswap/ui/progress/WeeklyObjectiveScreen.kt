...
private fun CreateObjectiveDialog(
    ...
    var tasksText by remember { mutableStateOf("Tâche 1\nTâche 2\nTâche 3") }
    ...
    androidx.compose.material3.AlertDialog(
        ...
        text = {
            Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                ...
                OutlinedTextField(value = targetHours, onValueChange = { targetHours = it }, label = { Text("Heures cibles") })
                OutlinedTextField(value = start, onValueChange = { start = it }, label = { Text("Début (ISO)") })
                OutlinedTextField(value = end, onValueChange = { end = it }, label = { Text("Fin (ISO)") })
                OutlinedTextField(
                    value = tasksText,
                    onValueChange = { tasksText = it },
                    label = { Text("Tâches (1 par ligne)") },
